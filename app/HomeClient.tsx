...
export default function HomeClient() {
  return (
    <div className="bg-white text-gray-900 overflow-hidden">
      ...
      {/* ── HERO — pure CSS, no framer-motion, renders instantly ── */}
      <section className="relative flex items-center justify-center py-10 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 pb-2 bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">            Free Expense Tracker & Budget Manager
          </h1>
      ...
      {/* ── CURRENCY — no motion per card (35 observers is too heavy) ── */}
