...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!accepted) {
      setError("You must accept policies to continue");
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              minLength={6}
              className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-gray-900"
              placeholder="••••••"
            />
        ...
        <div className="flex items-start gap-2 text-sm">
          ...
          <p className="text-gray-600">
            I agree to{" "}
            <Link href="/privacy-policy" className="text-indigo-600 font-medium">Privacy Policy</Link>,{" "}
            <Link href="/terms" className="text-indigo-600 font-medium">Terms & Conditions</Link>, and{" "}
            <Link href="/cookie-policy" className="text-indigo-600 font-medium">Cookies Policy</Link>.
          </p>
        </div>
