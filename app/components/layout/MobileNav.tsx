...
import { LayoutDashboard, List, Tags, User, Star } from "lucide-react";
    ...
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-gray-200 shadow-2xl z-50">
      ...
      <div className="flex justify-around items-center h-16 px-1">
        ...
        >
          ...
          <span className="text-[10px] font-medium mt-1 text-gray-500 group-hover:text-indigo-600 transition-colors">
            Review
          </span>
        </button>
      </div>
